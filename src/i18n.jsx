...
const ja = {
  ...
  hero: {
    ...
    subtitle: `私たちは「ふつうの不動産会社」ではありません。\nどの場面でも、お客様と一緒に新しい価値を見つけていくパートナーです。`,
  ...
  borders: [
    { key: 'language', title: `言語の境界`, body: `日本語・英語・中国語でお話しできます。言葉や国のちがいでつまずくことは、もうありません。` },
    { key: 'nation', title: `国の境界`, body: `海外の投資家の方と日本の不動産を、なめらかにおつなぎする架け橋になります。` },
    { key: 'expertise', title: `専門の境界`, body: `物件さがしから宿泊運営、価値の向上、管理、そして売却まで、すべてを私たちがまとめてお手伝いします。` },
    { key: 'time', title: `時間の境界`, body: `ご来日の前から、物件のご購入、その後の運用まで、どの場面でもずっとそばで一緒に進めます。` },
    { key: 'industry', title: `業界の境界`, body: `とにかく分かりやすく、正直な取引で。不動産業界にありがちな「わかりにくさ」を、なくしていきます。` },
  ],
  journey: {
    intro: `CROSSBORDERS は、民泊の運営からスタートしました。現場で積み重ねてきた経験をもとに、いまは国境を越えた不動産の価値づくりに力を入れています。`,
    milestones: [
    ...
    closing: `長く民泊を運営してきて分かったのは、\nどんなに条件のちがう物件でも、その良さを最大限に引き出せる、ということです。`,
  },
  metrics: {
    note: `※ 2018年時点の実績`,
    items: [
  ...
  valueChain: [
    { n: '01', en: 'DISCOVER', cn: `発掘`, title: `いい物件を見つける`, body: `提携先のネットワークから、表に出ていない物件の情報を集めます。「宿泊運営」と「投資」の両方の目で見て、まだ気づかれていない価値のある物件を見つけます。` },
    { n: '02', en: 'ACQUIRE', cn: `取得`, title: `購入のご判断をお手伝い`, body: `ホテル・民泊・シェアハウスなど、実際に運営した場合の「本当の利回り(実質利回り)」まで見て分析します。見かけの数字だけで判断せず、多言語で海外の投資家の方の購入のご判断をお手伝いします。` },
    { n: '03', en: 'ELEVATE', cn: `価値向上`, title: `物件の価値を高める`, body: `これまで培ってきたデザインとブランドづくりの力で、ふつうの物件を、泊まって楽しい「体験の場」に変えていきます。改装のプランから内装、ブランドづくりまで、まとめてお引き受けします。` },
    { n: '04', en: 'OPERATE', cn: `運営`, title: `しっかり運営して収益に`, body: `運営は私たちが引き受け、Airbnb や Booking.com などで集客します。多言語でのゲスト対応や、売上のチェックも、続けて行います。` },
    { n: '05', en: 'EXIT', cn: `出口`, title: `売却、または次の投資へ`, body: `運営で積み上げたデータと実績をもとに、相場を上回る価格での売却を目指します。あるいは、次の投資へつなげます。` },
  ],
  matrix: {
  ...
  strengths: [
    { n: '01', title: `多言語でのサポート`, en: 'Multilingual Service', body: `日本語・英語・中国語に対応しています。ただ「話せる」だけでなく、三つの文化の目線でお客様を理解できることが、私たちの強みです。` },
    { n: '02', title: `宿泊運営の実践経験`, en: 'Hospitality Expertise', body: `たくさんの運営経験があるので、「泊まる人の体験としての建物」の価値が見えます。「面積 × 単価」だけでは分からない見方を、大切にしています。` },
    { n: '03', title: `ブランドと空間づくり`, en: 'Brand & Space Design', body: `これまでの実績が示すとおり、ふつうの建物を、ストーリーとファンのある、少し特別な空間へと変えていきます。` },
    { n: '04', title: `世界とつながる顧客の輪`, en: 'Global Network & Expert Alliance', body: `世界中の旅行者・学生・投資家の方にサービスを届けてきました。国内でも、建築士・司法書士・行政書士・税理士・弁護士など、各分野の専門家としっかりつながっています。` },
  ],
  partnership: {
    philosophy: {
      title: `一度きりの取引ではなく、長く一緒に`,
      body: `私たちは「一度きりの取引」で終わりにしたくありません。資産と長くつきあいながら、ずっと一緒に価値を育てていきたいと思っています。\nお客様の資産は、10年、20年と、これからも価値を生み続けていくものです。\nだからこそ、ただの「仲介」ではなく、長くおつきあいできる「資産のパートナー」でありたいのです。`,
    },
    types: [
      { title: `物件提携`, en: 'Property Partnership', target: `パートナー企業・土地建物オーナー`, service: `物件をお持ちのパートナー様へ。海外の投資家ネットワーク、売却のご提案、運営のプラン、価値を高めるプランをご用意します。貴社の物件を、世界中の投資家やお客様へお届けします。`, value: `ただの「買い手」ではなく、その物件の良さを一番引き出せるお客様を見つけます。` },
      { title: `顧客送客`, en: 'Customer Referral', target: `語学学校・大学・士業・金融機関`, service: `御社のお客様へ、多言語の不動産サービス、外国人の方の入居サポート、海外投資家への対応をご提供します。おたがいにお客様を紹介し合える、長いおつきあいを目指します。`, value: `お客様の不動産の「困った」を解決して、御社への信頼につなげます。` },
      { title: `運営提携`, en: 'Operation Partnership', target: `宿泊事業者・投資家・地方自治体`, service: `これまでの実績をもとに、運営の受託、集客、空間づくり、地域おこしのお手伝いまでご一緒します。`, value: `お持ちの空間を、私たちの運営で「ストーリーとファンのある」資産に変えていきます。` },
    ],
  },
  faq: {
    eyebrow: 'Q&A',
  ...
  ui: {
    ...
    valueTeaserTitle: `資産ライフサイクル全体の価値マネジメント`, valueTeaserSubtitle: `Discover から Exit まで、お客様の歩む一歩一歩に寄り添う——それが事業における「Cross the Borders」の本当の意味です。`, valueTeaserLink: `価値づくりの流れを見る →`,
    homeCtaTitle: `いっしょに、新しい一歩を`, homeCtaSubtitle: `土地オーナー様、投資家様、提携をお考えの方も、まずはお気軽にご相談ください。`, homeCtaButton: `お問い合わせ`,
    aboutEyebrow1: `01 · ブランド哲学`, aboutTitle1: `CROSSBORDERS の意味`, aboutIntro1: `"Cross the Borders" ——境界を越えて、新しい価値を。\nこの社名は、ただの名前ではなく、私たちの大切な考え方そのものです。\nいまの日本の不動産業界には、まだ五つの見えない「境界」があると、私たちは感じています。`,
    aboutEyebrow2: `02 · 私たちの歩み`, aboutTitle2: `CROSSBORDERS のこれまで`,
    valueEyebrow: `03 · 私たちの価値創造`, valueTitle: `資産ライフサイクル全体の価値マネジメント`, valueIntro: `ふつうの不動産会社がするのは「売買仲介」だけ。私たちは、バラバラのサービスではなく、ひとつながりの流れとしてまとめてご提供します。`,
    matrixTitle: `私たちの差別化`, matrixSubtitle: `不動産会社、運営会社、コンサルティング会社は数あれど、この三つを兼ね備える会社はごくわずかです。`, matrixCapHeader: `能力`,
    strengthsTitle: `四つの強み`, valueCtaButton: `ご要望を相談する`,
    partnershipEyebrow: `04 · 協働の哲学`, partnershipTitle: `三つの協働のかたち`, partnershipSubtitle: `いろいろな分野のパートナーと、さまざまな形で価値を生み出せます。`,
    ...
    homePositioning: `ふつうの仲介がするのは「売買」「賃貸」の一面だけ。\n私たちはその境界を越えて、物件さがしから売却まで、どの場面でも\n価値を最大限に引き出します。`,
    portalAbout: `五つの境界を越える、不動産のプロチーム`, portalValue: `物件さがしから売却まで、どの段階もずっと一緒に`, portalPartner: `不動産会社・団体・運営者の皆さんと、長く一緒に価値をつくる`, learnMore: `詳しく見る →`,
