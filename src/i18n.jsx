...
const ja = {
  ...
  partnership: {
    philosophy: {
      ...
      body: `私たちは「一度きりの取引」を求めません。「資産のライフサイクル全体にわたる長期的な伴走」を目指します。\nお客様の資産は10年、20年という周期で価値を生み続ける必要があります。私たちは単なる「仲介」ではなく、長期的な「資産パートナー」でありたいのです。`,
    },
    types: [
  ...
  ui: {
    ...
    homePositioning: `従来の仲介が担うのは「売買」「賃貸」という一面だけ。\n私たちは、その境界を越え、資産の発掘から出口戦略に至るすべてのフェーズで、価値を最大化します。`,
...
const zh = {
  ...
  ui: {
    ...
    homeCtaTitle: `一起，迈向新的边界`, homeCtaSubtitle: `无论您是土地业主、投资人，还是正在考虑合作的伙伴，欢迎随时与我们联系。`, homeCtaButton: `联系我们`,
    ...
    homePositioning: `传统中介只负责「买卖」「租赁」这一面。\n我们跨越这道边界，在从资产发掘到退出战略的每一个阶段，将价值最大化。`,
...
const en = {
  ...
  hero: {
    ...
    titleEn: ``,
    subtitle: `We are not "just another real estate company."\nWe are a partner that exists for clients who pursue value creation at every stage.`,
  ...
  borders: [
    ...
    { key: 'nation', title: `The national border`, body: `A dependable bridge that seamlessly connects overseas investors with Japan's property market.` },
    { key: 'expertise', title: `The expertise border`, body: `From sourcing to hospitality operation, value enhancement, management and exit — integrated end to end.` },
    { key: 'time', title: `The time border`, body: `From before arrival to acquisition, operation and the investment phase — we accompany every step.` },
    { key: 'industry', title: `The industry border`, body: `With radically transparent, clean dealing, we break the industry's old "opaque" image.` },
  ],
  journey: {
  ...
  valueChain: [
    ...
    { n: '02', en: 'ACQUIRE', cn: ``, title: `Support the purchase decision`, body: `We analyze the effective yield including operating scenarios such as hotels, hostels, vacation rentals and shared housing — not just the surface rental yield — and support overseas investors' purchase decisions in multiple languages.` },
    { n: '03', en: 'ELEVATE', cn: ``, title: `Elevate asset value`, body: `With the outstanding design and brand strength we have built, we elevate ordinary properties into valuable "experiential spaces" — handling renovation planning, interior design and brand design end to end.` },
  ...
  strengths: [
    ...
    { n: '02', title: `Hands-on hospitality experience`, en: 'Hospitality Expertise', body: `With our rich operating experience, we see a building's value "as an experiential space" — a perspective that "area × unit price" alone cannot measure.` },
    { n: '03', title: `Brand & space creation`, en: 'Brand & Space Design', body: `As our extensive track record shows, we transform ordinary buildings into branded spaces with a story, fans and a premium.` },
    { n: '04', title: `Global customer network`, en: 'Global Network & Expert Alliance', body: `We have served travelers, students and investors from around the world, and have built a strong network with domestic experts across fields — architects, judicial scriveners, administrative scriveners, tax accountants and lawyers.` },
  ],
  partnership: {
    philosophy: {
    ...
    types: [
      { title: `Property Partnership`, en: ``, target: `Partner companies & property owners`, service: `For partners who hold properties: an overseas-investor network, exit strategy, operation proposals and value-enhancement plans. We bring your property to investors and clients worldwide.`, value: `We find not "just a buyer," but "a client who can draw out your property's full value."` },
      { title: `Customer Referral`, en: ``, target: `Language schools, universities, professional & financial firms`, service: `For your clients: multilingual real-estate service, move-in support for foreign residents, hosting of overseas investors — a long-term mutual-referral network.`, value: `We solve your clients' real-estate "headaches" and turn them into "even greater trust in your company."` },
      { title: `Operation Partnership`, en: ``, target: `Hospitality operators, investors, local governments`, service: `We provide operation outsourcing, OTA marketing, space planning and regional-revitalization collaboration built on our extensive track record.`, value: `Turn the space you hold into an asset "with a story and fans" through our operating brand.` },
    ],
  },
  ...
  ui: {
    ...
    partnershipEyebrow: `04 · Partnership philosophy`, partnershipTitle: `Three ways to partner`, partnershipSubtitle: `With partners across different fields, we can create value in different forms.`,
    ...
    homePositioning: `A traditional brokerage handles only one side — buying/selling and leasing.\nWe cross that border to maximize value at every phase, from sourcing to exit strategy.`,
    portalAbout: `A professional property team that crosses five borders`, portalValue: `From discovery to exit — alongside every stage of the asset`, portalPartner: `Long-term value co-creation with firms, institutions and operators`, learnMore: `Learn more →`,
