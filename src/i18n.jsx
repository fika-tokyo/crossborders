...
const ja = {
  ...
  hero: {
    ...
    subtitle: `私たちは「ただの不動産会社」ではありません。\n境界を越え、全工程での価値創造を必要とするお客様のために存在する会社です。`,
  ...
  ui: {
    ...
    homePositioning: `従来の仲介が担うのは「売買」という一工程だけ。\n私たちは、境界を越えた全工程での価値創造を担います。`,
...
const en = {
  ...
  ui: {
    ...
    homePositioning: `A traditional brokerage handles just one link — the deal.\nWe create value across the entire cross-border journey.`,
